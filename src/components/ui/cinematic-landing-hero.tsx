...
const INJECTED_STYLES = `
  ...
  .premium-depth-card {
      background: linear-gradient(145deg, #012d1d 0%, #000000 100%);
      box-shadow: 
  ...
  .card-sheen {
      ...
      background: radial-gradient(800px circle at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(255,255,255,0.1) 0%, transparent 40%);
...
export function CinematicHero({ 
  brandName = "NaijaFit",
  tagline1 = "No shame,",
  tagline2 = "just progress.",
  cardHeading = "Fitness for Your Reality",
  cardDescription = <><span className="text-white font-semibold">NaijaFit</span> respects your culture, your food, and your schedule. Experience a fitness journey with Jollof-friendly macros and 5-minute bed stretches.</>,
  metricValue = 10,
  metricLabel = "Streak Days",
  ctaHeading = "Start your journey.",
  ctaDescription = "Join thousands of others in the NaijaFit community and take control of your health today.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      introTl
        ...
        .to([".text-track", ".text-days"], { duration: 1, autoAlpha: 0, y: -20, ease: "power2.in", delay: 2 });
  ...
  return (
    <div
      ref={containerRef}
      className={cn("relative w-full h-screen overflow-hidden flex items-center justify-center bg-background text-on-background font-jakarta antialiased", className)}
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <h1 className="text-track gsap-reveal text-3d-matte text-5xl md:text-7xl lg:text-[6rem] font-bold tracking-tight mb-2 text-primary">
          {tagline1}
        </h1>
        <h1 className="text-days gsap-reveal text-secondary text-5xl md:text-7xl lg:text-[6rem] font-extrabold tracking-tighter">
          {tagline2}
        </h1>
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight text-primary">
          {ctaHeading}
        </h2>
        <p className="text-slate-600 dark:text-emerald-100/60 text-lg md:text-xl mb-12 max-w-xl mx-auto font-light leading-relaxed">
          {ctaDescription}
        </p>
        <div className="flex flex-col sm:flex-row gap-6">
          <Link href="/onboarding" className="bg-secondary text-white px-10 py-5 rounded-full font-bold shadow-xl hover:scale-105 transition-transform">
            Start Your Journey
          </Link>
          <Link href="/pro" className="border-2 border-primary dark:border-white text-primary dark:text-white px-10 py-5 rounded-full font-bold hover:bg-primary dark:hover:bg-white hover:text-white dark:hover:text-primary transition-all">
            Explore Plans
          </Link>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-6xl md:text-[6rem] lg:text-[8rem] font-black uppercase tracking-tighter text-white/10 lg:mt-0">
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                  ...
                  <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        ...
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">JD</div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="88" cy="88" r="64" fill="none" stroke="#fd7729" strokeWidth="12" />
                        </svg>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">8 Day Streak</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Keep going!</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Jollof Logged</p>
                    <p className="text-orange-200/50 text-[10px] lg:text-xs font-medium">Fuel for progress</p>
                  </div>
                </div>
